...
const cli1 = new banco_1.Cliente(1, "Mitsuki Miyawaki", "111.111.111-11", new Date("1990-09-23"));
const cli2 = new banco_1.Cliente(2, "BeKarly Marina Loaizato", "222.222.222-22", new Date("1994-07-17"));
const cli3 = new banco_1.Cliente(3, "Laufey Lín Bing", "333.333.333-33", new Date("1999-04-23"));
const cli4 = new banco_1.Cliente(4, "Amala Ratna Zandile", "444.444.444-44", new Date("1995-10-21"));
const cli5 = new banco_1.Cliente(5, "Sia Kate Isobelle", "555.555.555-55", new Date("1975-12-18"));
...
const c1 = new banco_1.Conta(1, "0001", new Date(), 1000);
const c2 = new banco_1.Conta(2, "0002", new Date(), 200);
const c3 = new banco_1.Conta(3, "0003", new Date(), 50);
const c4 = new banco_1.Conta(4, "0004", new Date(), 0);
const c5 = new banco_1.Conta(5, "0005", new Date(), 500);
